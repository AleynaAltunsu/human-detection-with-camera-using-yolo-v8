...
model = YOLO('yolov10n.pt')  # Ensure you have the appropriate YOLOv10 weights
...
#precission ve accuracy değerleri genellikle 1 ve 0.5 arası değişkenlik gösteriyor
